...
> 供 `xinli` skill 引用。公共登录元素见 [../../common/elements/login.md](../../common/elements/login.md)，公共弹窗元素见 [../../common/elements/dialog.md](../../common/elements/dialog.md)。

包名：`com.gaotu100.xinli`
...
|--------|---------|---------|
| 上课 tab | xpath | `//*[@resource-id='com.gaotu100.xinli:id/tab_title'][@text='上课']` |
| 我的 tab | xpath | `//*[@resource-id='com.gaotu100.xinli:id/tab_title'][@text='我的']` |
...
| 元素 | resource-id |
|------|-------------|
| 底部 tab 标题 | `com.gaotu100.xinli:id/tab_title` |
| 广告关闭按钮 | `com.gaotu100.xinli:id/ad_close` |
| 协议确认按钮 | `com.gaotu100.xinli:id/customer_dialog_ok` |
